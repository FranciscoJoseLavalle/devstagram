            ...
            <form action="{{ route('register') }}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="name" name="name" placeholder="Tu nombre"
                        class="border p-3 w-full rounded-lg outline-sky-400 @error('name')
                            border-red-500
                        @enderror"
                        value="{{ old('name') }}">
                    @error('name')
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="username" name="username" placeholder="Tu nombre de usuario"
                        class="border p-3 w-full rounded-lg outline-sky-400 @error('username')
                        border-red-500
                    @enderror"
                        value="{{ old('username') }}">
                    @error('username')
                ...
                <div class="mb-5">
                    ...
                    <input type="email" id="email" name="email" placeholder="Tu email de registro"
                        class="border p-3 w-full rounded-lg outline-sky-400 @error('email')
                        border-red-500
                    @enderror"
                        value="{{ old('email') }}">
                    @error('email')
                ...
                <div class="mb-5">
                    ...
                    <input type="password" id="password" name="password" placeholder="Tu password de registro"
                        class="border p-3 w-full rounded-lg outline-sky-400 @error('password')
                        border-red-500
                    @enderror">
                    @error('password')
                        <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{ $message }}</p>
                ...
                <div class="mb-5">
                    ...
                    <input type="password" id="password_confirmation" name="password_confirmation"
                        placeholder="Tu password de registro" class="border p-3 w-full rounded-lg outline-sky-400">
                </div>
